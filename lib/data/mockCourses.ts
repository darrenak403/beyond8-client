...
export const newCourses: Course[] = [
  {
    ...
    category: 'Backend', // Kept for UI compatibility
    level: 'Intermediate',
    language: 'vi-VN',
    price: 1200000,
    thumbnailUrl: 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80',
    outcomes: [
      'Hiểu rõ Clean Architecture và ứng dụng vào dự án thực tế',
      'Thành thạo Entity Framework Core và tối ưu hiệu suất DB',
      'Triển khai Authentication/Authorization với JWT và Identity',
      'Viết Unit Test và Integration Test chuẩn chỉ'
    ],
    requirements: [
      'Đã có kiến thức C# căn bản',
      'Hiểu biết về SQL Server',
      'Cài đặt sẵn Visual Studio 2022 hoặc VS Code'
    ],
    targetAudience: [
      'Backend Developer muốn nâng cao trình độ',
      'Sinh viên năm cuối làm đồ án tốt nghiệp',
      'Fullstack Developer muốn củng cố mảng Backend'
    ],
    instructorId: '019bf652-223e-70b7-8b1b-1372e11f0e98',
    instructor: 'Expert Instructor', // Kept for UI compatibility
    rating: 5.0,
    students: 0,
    duration: '30 giờ'
  },
