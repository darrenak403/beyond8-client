...
import VideoLesson from '../../[courseId]/(learning)/[sectionId]/[lessonId]/components/VideoLesson'
...
export default function WatchPage() {
  ...
  if (shouldFetchDetails && isLoadingVideo) {
    return (
      <div className="w-full max-w-[1600px] mx-auto p-0 lg:p-6">
        <Skeleton className="w-full aspect-video" />
  ...
  const isNextDisabled = !isLessonCompleted && !isVideoCompletedLocal
        ...
        <div className="flex-1 min-w-0">
          <div className="w-full max-w-6xl mx-auto">
            <VideoLesson
              ...
              variants={variants}
              durationSeconds={'durationSeconds' in lesson ? lesson.durationSeconds : null}
        ...
        <LessonInfo
          ...
          onNavigate={(navSectionId, navLessonId) => {
            if ((nextLessonItem && nextLessonItem.id === navLessonId) || (!nextLessonItem && navLessonId === lessonId)) {
              ...
              // Navigate to the selected lesson - determine type
