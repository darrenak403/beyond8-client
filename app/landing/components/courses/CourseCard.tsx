    ...
    <Link href={courseUrl} target="_blank" className="block h-full">
      <div className="group cursor-pointer h-full flex flex-col">
        ...
        <div className="relative w-full aspect-square mb-4 rounded-2xl overflow-hidden">
          ...
          <Badge
            variant="outline"
            className="absolute top-3 left-3 rounded-xl bg-white/90 backdrop-blur-sm group-hover:border-primary group-hover:text-primary transition-colors duration-300"
          >
        ...
        <div className="flex-1 flex flex-col group-hover:text-primary transition-colors duration-300">
          <h3 className="font-semibold text-lg mb-2 line-clamp-2 min-h-[3.5rem]">{course.title}</h3>
