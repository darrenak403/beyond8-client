...
import CourseGridItem from '@/app/(admin)/admin/course/components/CourseGridItem'
import CourseListItem from '@/app/(admin)/admin/course/components/CourseListItem'
import CourseToolbar from '@/app/(admin)/admin/course/components/CourseToolbar'
import CoursePagination from '@/app/(admin)/admin/course/components/CoursePagination'
