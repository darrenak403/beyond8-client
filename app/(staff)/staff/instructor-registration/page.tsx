...
import { getColumns } from "@/app/(admin)/admin/instructor-registration/components/Columns";
import { RegistrationTableToolbar } from "@/app/(admin)/admin/instructor-registration/components/RegistrationTableToolbar";
import { RegistrationDialog } from "@/app/(admin)/admin/instructor-registration/components/RegistrationDialog";
...
import { RejectDialog } from "@/app/(admin)/admin/instructor-registration/components/RejectDialog";

import { RegistrationTableSkeleton } from "@/app/(admin)/admin/instructor-registration/components/RegistrationTableSkeleton";
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";
import { AlertCircle, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from "lucide-react";
import { MobileRegistrationCard } from "@/app/(admin)/admin/instructor-registration/components/MobileRegistrationCard";
