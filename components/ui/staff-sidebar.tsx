...
const menuItems = [
    ...
    { icon: FileCheck, label: 'Duyệt giảng viên', href: '/staff/instructor-registration' },
    { icon: BookOpen, label: 'Khóa học', href: '/staff/course' },
    { icon: BarChart3, label: 'Báo cáo', href: '/staff/report' },
];
        ...
        >
            <div className="flex flex-col h-full">
                ...
                <div className="px-3 py-1 border-b border-gray-200">
                    <Link href="/staff/dashboard" className="flex items-end gap-2">
                        <Image
                            src="/icon-logo.png"
                            alt="Beyond 8"
                            width={20}
                                    ...
                                    <TooltipContent side="right" className="p-0 w-56">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="px-3 py-2 border-b">
                                                <p className="font-medium text-sm">{userProfile?.fullName || 'Staff'}</p>
