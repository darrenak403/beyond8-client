...
export function StudentCourseFilterSheet({ activeFilterCount = 0 }: StudentCourseFilterSheetProps) {
    ...
    // Price distribution data (same shape/idea as in Header.tsx)
    // price is in triệu VND (0 - 5), count is number of courses
                            ...
                            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-transparent hover:[&::-webkit-scrollbar-thumb]:bg-gray-300 transition-colors">
                                ...
                                >
                                    ...
                                    <motion.div variants={{ hidden: { x: 50, opacity: 0 }, visible: { x: 0, opacity: 1 } }} className="space-y-4">
                                        ...
                                        {/* Mini price distribution chart (re-uses logic/data shape from Header.tsx) */}
