          ...
          <div className="grid grid-cols-2 gap-4">
                    ...
                    className={`flex-1 rounded-lg border-2 px-4 py-2 text-sm font-medium transition-all ${
                      difficulty === level
                        ? level === QuestionDifficulty.Easy
                          ...
                          ? "border-yellow-500 bg-yellow-50 text-yellow-700 dark:bg-yellow-950"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="border-brand-magenta/20 bg-white/50 backdrop-blur-sm focus:border-brand-magenta dark:bg-black/50"
              />
            </div>
          </div>
